...
public class MainScene extends Scene
{
	public void activate()
	{
		...
		GameObject.create(new GameObject("Button Stop", new Component[] { new Button(new Rect(Screen.width / 2 - 100, Screen.height / 2 + 25, 200, 50), "Stop", "/Images/Square.png", () -> Game.instance.isRunning = false) }), new Vector2(), 0f);
	}
}