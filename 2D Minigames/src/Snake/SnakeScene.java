...
public class SnakeScene extends Scene
{
	public void activate()
	{
		...
		GameObject.create(new GameObject("Snake", "Snake", new Component[] { new Snake(), new Image("Images/Square.png", 10, new Color(0, 200, 20, 255)) }), new Vector2(Screen.width / 2, Screen.height / 2), 0f);
		...
		/*GameObject.create(wall1, new Vector2(0f, -Screen.height / 2f), 0f);
		GameObject.create(wall2, new Vector2(0f, Screen.height / 2f), 0f);
		GameObject.create(wall3, new Vector2(-Screen.width / 2f, 0f), 0f);
		GameObject.create(wall4, new Vector2(Screen.width / 2f, 0f), 0f);*/
